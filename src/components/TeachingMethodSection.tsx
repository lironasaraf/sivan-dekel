...
const TeachingMethodSection = () => {
  ...
  return (
    <section 
      id="teaching-method" 
      ref={sectionRef}
      className="py-12 md:py-16 bg-gradient-to-br from-greek-turquoise/10 to-white"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-8">
          ...
          <p className={`text-lg text-gray-700 mt-3 max-w-2xl mx-auto transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '100ms' }}>
            מודל לימוד ייחודי ומותאם במיוחד לישראלים
          </p>
        </div>

        <div className="flex flex-row gap-4 md:gap-6 mb-12">
        ...
        <div className={`mb-8 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '400ms' }}>
          <div className="greek-card max-w-3xl mx-auto py-4">
        ...
        <div className={`mb-8 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '500ms' }}>
          <div className="text-center mb-6">
            <h3 className="text-lg font-heading text-greek-blue mb-3">מבנה השיעור - שלושה חלקים</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {lessonStructure.map((part, index) => {
              ...
              return (
                <div key={index} className={`greek-card text-center py-4 transition-all duration-800 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: `${600 + index * 100}ms` }}>
        ...
        <div className={`mb-8 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '800ms' }}>
          <div className="text-center mb-6">
            <h3 className="text-lg font-heading text-greek-blue mb-3">לאחר כל שיעור תקבלו</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {postLessonMaterials.map((material, index) => {
              ...
              return (
                <div key={index} className={`greek-card text-center py-4 transition-all duration-800 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: `${900 + index * 100}ms` }}>
                  <div className="flex justify-center mb-3">
        ...
        <div className={`text-center transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1000ms' }}>
          <div className="greek-card max-w-2xl mx-auto bg-gradient-to-r from-greek-blue/5 to-greek-turquoise/5 py-4">
            <div className="flex justify-center items-center gap-3 mb-3">
